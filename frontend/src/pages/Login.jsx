...
import { GraduationCap, BookOpen, Shield, LogIn, Eye, EyeOff } from 'lucide-react';
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.ok && trimmedPassword.length > 0) {
        ...
        setMessage({ text: '❌ Login failed! Check credentials.', type: 'error' });
      }
    } catch (err) {
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4 antialiased">
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-black/80">Smart QR + Beacon Based Attendance System</p>
        </div>
