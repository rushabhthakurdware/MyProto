...
const AttendancePanel = ({ sessionActive, onStartSession, onStopSession }) => {
  ...
  return (
    <Card className="w-full max-w-md mx-auto p-6 overflow-y-auto bg-white shadow-lg rounded-xl mt-15">
      <h2 className="text-2xl font-bold text-gray-800 mb-5 text-center">STUDENTS</h2>
              ...
              <ul>
                {filteredStudents.map((student) => (
                  ...
                  >
                    ...
                    <span className="text-gray-600 text-sm mt-1 sm:mt-0">ID: {student.id}</span>
                  </li>
                ))}
              </ul>
            )}
